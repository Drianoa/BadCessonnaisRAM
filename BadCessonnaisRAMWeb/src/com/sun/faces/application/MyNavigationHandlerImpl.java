...
/**
 * Copie du navigationHandler de sun mais avec un peu plus de logs...
 * 
 */

public class MyNavigationHandlerImpl extends ConfigurableNavigationHandler {
     ...
     */
    public MyNavigationHandlerImpl() {
        ...
        if (null != viewIdToTest) {
            ...
            return caseStruct;
        	 ...
        	 if (logger.isLoggable(Level.WARNING)) {
                 logger.log(Level.WARNING, "Aucune correspondance pour "+save);
             }
        }
